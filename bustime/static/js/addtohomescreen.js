...
ath.intl = {
	...
	ru_ru: {
		message: 'Чтобы добавить это приложение на ваш домашний экран: нажмите %icon и потом <strong>%action</strong>.',
		action: { ios: 'На экран <<Домой>>', android: 'Добавить на главный экран', windows: 'прикрепить к пуску' }
	},
