/* функции/переменные, необходимые независимо от того, лавная страница или нет */
...
function getUserAgent(){
    if (navigator.userAgentData) {
        return JSON.stringify(navigator.userAgentData.brands).replace(/[\[\]\{\}"]/g, "");
    } else {
...
function isChrome(){
    if (navigator.userAgentData) {
        return /chrome|chromium/i.test(getUserAgent());
    } else {
